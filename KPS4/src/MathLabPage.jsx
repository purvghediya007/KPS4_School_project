...
const tabs = [
  { id: 1, title: "Math Lab at a Glance" },
  { id: 2, title: "Math Lab Detail" },
];
                ...
                <>
                  ...
                  <div className="bg-gradient-to-br from-[#fff8f8] to-[#ffeaea] p-6 rounded-lg shadow-md border border-[#f5d1d1]">
                    <p className="text-gray-800 leading-relaxed text-lg mb-4">
                      ...
                      offers interactive learning tools and manipulatives to
                      help students explore concepts like geometry, algebra, and
                      measurements. It encourages logical thinking and
                      problem-solving through hands-on activities and models.
                    </p>
                    <ul className="list-none space-y-3 text-gray-700 text-base">
                      <li className="flex items-start gap-3">
                        ...
                        Well-equipped stations for geometry experiments.
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-[#b40000] font-bold text-lg">
                          🔢
                        </span>
                        Tools for exploring algebraic concepts in an
                        interactive way.
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-[#b40000] font-bold text-lg">
                        ...
                        Measurement kits for practical learning.
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-[#b40000] font-bold text-lg">
                          🧠
                        </span>
                        Puzzle and problem-solving activities to boost
                        reasoning skills.
                      </li>
                    </ul>
