...
const tabs = [
  { id: 1, title: "Smart Class at a Glance" },
  { id: 2, title: "Smart Class Detail" },
];
              ...
              {activeTab.id === 1 && (
                <>
                  <h2 className="text-xl font-bold text-[#b40000] mb-4">
                    Smart Class at a Glance
                  </h2>
<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
  {[
    { src: slide1, label: "Interactive Display Board" },
    { src: "smart2.jpg", label: "Digital Learning Setup" },
    { src: "smart3.jpg", label: "Live Streaming Facility" },
    { src: "smart4.jpg", label: "HD Projector & Sound" },
  ].map((item, index) => (
    <div
      key={index}
                ...
                <>
                  ...
                  <div className="bg-gradient-to-br from-[#fff8f8] to-[#ffeaea] p-6 rounded-lg shadow-md border border-[#f5d1d1]">
                    <p className="text-gray-800 leading-relaxed text-lg mb-4">
                      ...
                      at our institute provide students with a technologically
                      enriched learning environment. They include digital
                      whiteboards, audio-visual aids, high-speed connectivity,
                      and e-learning integration.
                    </p>
                    <ul className="list-none space-y-3 text-gray-700 text-base">
                      <li className="flex items-start gap-3">
                        ...
                        Interactive learning using smart boards and multimedia
                        tools.
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-[#b40000] font-bold text-lg">
                        ...
                        High-speed internet and real-time online collaboration.
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-[#b40000] font-bold text-lg">
                          🎥
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        Modern infrastructure that enhances engagement and
                        creativity.
                      </li>
                    </ul>
                    <p className="mt-6 text-gray-800 italic text-base">
                      "Technology in the classroom isn't the end goal — it's a
                      means to empower students to think, learn, and innovate."
                    </p>
                  </div>
                </>
              )}
